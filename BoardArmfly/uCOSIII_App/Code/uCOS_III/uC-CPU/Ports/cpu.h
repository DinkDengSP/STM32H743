...
*********************************************************************************************************
*/
/* Configure CPU critical method      (see Note #1) :   临界段处理*/
...
/* Save CPU current BASEPRI priority lvl for exception. 关闭系统中断*/
#define  CPU_INT_DIS()         do { cpu_sr = CPU_SR_Save(CPU_CFG_KA_IPL_BOUNDARY << (8u - CPU_CFG_NVIC_PRIO_BITS));} while (0)
/* Restore CPU BASEPRI priority level.         恢复系统中断 */
